...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { overlayClassName?: string; closeLabel?: string; closeClassName?: string }
>(({ className, children, overlayClassName, closeLabel = 'Close', closeClassName, ...props }, ref) => (
  <DialogPortal>
